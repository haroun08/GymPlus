...
import static com.smz.gymplus.domain.CategoryAsserts.*;
...
import com.smz.gymplus.domain.Category;
import com.smz.gymplus.repository.CategoryRepository;
...
class CategoryResourceIT {
    ...
    void partialUpdateCategoryWithPatch() throws Exception {
        ...
        assertSameRepositoryCount(databaseSizeBeforeUpdate);
        assertCategoryUpdatableFieldsEquals(partialUpdatedCategory, getPersistedCategory(category));
    }
