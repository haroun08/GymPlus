...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './period.reducer';
...
describe('Entities reducer tests', () => {
  ...
  const initialState: EntityState<IPeriod> = {
    loading: false,
    errorMessage: null,
    entities: [],
    entity: defaultValue,
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PERIOD_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PERIOD actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PERIOD actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PERIOD actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PERIOD actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PERIOD actions', async () => {
      const arg = 42666;
