...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ORDERUNIT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ORDERUNIT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ORDERUNIT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ORDERUNIT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ORDERUNIT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ORDERUNIT actions', async () => {
      const arg = 42666;
