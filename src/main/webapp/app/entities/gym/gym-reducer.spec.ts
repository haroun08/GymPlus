...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './gym.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GYM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_GYM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_GYM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_GYM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_GYM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_GYM actions', async () => {
      const arg = 42666;
