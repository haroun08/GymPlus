...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRODUCTHISTORY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PRODUCTHISTORY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PRODUCTHISTORY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PRODUCTHISTORY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PRODUCTHISTORY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PRODUCTHISTORY actions', async () => {
      const arg = 42666;
