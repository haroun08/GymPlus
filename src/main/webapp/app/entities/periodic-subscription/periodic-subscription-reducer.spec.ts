...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './periodic-subscription.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PERIODICSUBSCRIPTION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PERIODICSUBSCRIPTION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PERIODICSUBSCRIPTION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PERIODICSUBSCRIPTION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PERIODICSUBSCRIPTION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PERIODICSUBSCRIPTION actions', async () => {
      const arg = 42666;
