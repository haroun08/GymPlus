...
import com.smz.gymplus.domain.Payment;
import com.smz.gymplus.repository.PaymentRepository;
...
/**
 * REST controller for managing {@link com.smz.gymplus.domain.Payment}.
 */
@RestController
...
public class PaymentResource {
    ...
    public ResponseEntity<Payment> createPayment(@RequestBody Payment payment) throws URISyntaxException {
        ...
        return ResponseEntity
            .created(new URI("/api/payments/" + payment.getId()))
