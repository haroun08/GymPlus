...
import com.smz.gymplus.domain.Product;
import com.smz.gymplus.repository.ProductRepository;
...
/**
 * REST controller for managing {@link com.smz.gymplus.domain.Product}.
 */
@RestController
    ...
    public ResponseEntity<Product> partialUpdateProduct(
        ...
        Optional<Product> result = productRepository
            ...
            .map(existingProduct -> {
                ...
                if (product.getAvailableStockQuantity() != null) {
                    existingProduct.setAvailableStockQuantity(product.getAvailableStockQuantity());
                }
